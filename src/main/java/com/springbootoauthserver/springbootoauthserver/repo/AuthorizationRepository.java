...
public interface AuthorizationRepository extends JpaRepository<Authorization, String> {
    ...
    @Query("SELECT a FROM Authorization a WHERE a.principalName = :principalName ORDER BY a.authorizationCodeIssuedAt DESC")
    Optional<Authorization> findFirstByPrincipalNameOrderByAuthorizationCodeIssuedAtDesc(@Param("principalName") String principalName);
